...
export default function CreatePostPage() {
  ...
  const handleAiGenerate = async () => {
    ...
    try {
      ...
      toast.success("🎉 AI đã tạo nội dung! Hãy review trước khi xuất bản.");
    } catch (error) {
    ...
    <div className="mx-auto max-w-5xl space-y-6">
      ...
      <div className="bg-gradient-to-br from-violet-50 to-indigo-50 rounded-2xl border border-violet-200 p-6 space-y-4">
        ...
        <p className="text-sm text-violet-600/80">
          Dán link bài viết tham khảo hoặc mô tả chủ đề, AI sẽ viết lại nội dung
          chuẩn SEO cho bạn.
        </p>
        ...
        <div className="space-y-3">
          <div className="relative">
            ...
            <input
              type="url"
              placeholder="Dán URL bài viết tham khảo (VD: https://example.com/bai-viet)"
              value={aiUrl}
          ...
          <div className="relative">
            ...
            <textarea
              placeholder="Hoặc mô tả chủ đề bạn muốn viết (VD: Hướng dẫn móc len cơ bản cho người mới)"
              value={aiPrompt}
      ...
      <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
        ...
        <div className="flex items-center gap-1 px-4 py-2 border-b border-slate-100 bg-slate-50 flex-wrap">
          <button
            ...
            className="p-2 hover:bg-slate-200 rounded-lg transition-colors text-slate-600 cursor-pointer"
            title="In đậm"
          >
      ...
      <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
        ...
        {showSeo && (
          <div className="px-6 pb-6 space-y-4 border-t border-slate-100 pt-4">
            <div className="space-y-2">
              <label className="text-sm font-medium text-slate-600">
                SEO Title (khuyến nghị dưới 60 ký tự)
              </label>
              <input
                type="text"
                value={seoTitle}
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-slate-600">
                Meta Description (khuyến nghị dưới 160 ký tự)
              </label>
              <textarea
                value={seoDescription}
                onChange={(e) => setSeoDescription(e.target.value)}
                placeholder="Mô tả meta cho Google..."
                rows={3}
                className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm outline-none focus:ring-2 focus:ring-amber-500 transition-all resize-none"
              />

    ...
    <div className="space-y-8 max-w-7xl mx-auto">
      ...
      <div className="bg-white p-4 rounded-2xl shadow-[0_2px_12px_-4px_rgba(0,0,0,0.08)] border border-slate-100 flex flex-col md:flex-row gap-4 justify-between items-center">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          <button className="flex items-center gap-2 px-4 py-2.5 text-slate-600 bg-slate-50 hover:bg-slate-100 rounded-xl font-medium transition-colors border border-slate-200 w-full md:w-auto justify-center">
